 ...
 * <br>
 */
public class ConsolidationCustApplicationServiceImpl
        implements ConsolidationCustApplicationService {
    private final ConsolidationCustDomainService consolidationCustDomainService;

    public ConsolidationCustApplicationServiceImpl(ConsolidationCustDomainService consolidationCustDomainService) {
        this.consolidationCustDomainService = consolidationCustDomainService;
    }
    ...
    public ConsolidationCustExecuteResponse execute(ConsolidationCustExecuteRequest request) {
        ...
        consolidationCustDomainService.execute(CustAcctInfoConvert.INSTANCE.covertInputDto(request));
        return new ConsolidationCustExecuteResponse();
    }
}
