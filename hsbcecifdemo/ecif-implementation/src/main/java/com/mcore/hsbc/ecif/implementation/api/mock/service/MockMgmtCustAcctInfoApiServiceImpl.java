...
import com.mcore.hsbc.ecif.implementation.api.service.MgmtCustAcctInfoApiServiceImpl;
 ...
 * 
 */
public class MockMgmtCustAcctInfoApiServiceImpl
    extends MgmtCustAcctInfoApiServiceImpl
    implements MgmtCustAcctInfoApiService
{
    ...
    private static final String SERVICE_NAME = "mgmtCustAcctInfoApiService";
    private static final String INTERFACE_NAME = "MgmtCustAcctInfoApiService";
    ...
    public MgmtCustAcctInfoExecuteResponse execute(MgmtCustAcctInfoExecuteRequest request) {
        ...
        MgmtCustAcctInfoExecuteResponse response = mockService.getMockData(SERVICE_NAME, methodName, request, MgmtCustAcctInfoExecuteResponse.class);
        if (response == null) {
            return super.execute(request);
        }
        return response;
