...
public class CrtPerCustInfoFER202509160047622Wrapper implements WrapHandler {

    public static final Logger logger = LoggerFactory.getLogger(CrtPerCustInfoFER202509160047622Wrapper.class);
