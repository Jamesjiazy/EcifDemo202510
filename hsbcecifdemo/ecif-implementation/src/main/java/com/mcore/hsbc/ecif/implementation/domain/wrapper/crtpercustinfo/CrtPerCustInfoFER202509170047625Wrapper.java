...
public class CrtPerCustInfoFER202509170047625Wrapper implements WrapHandler {

    public static final Logger logger = LoggerFactory.getLogger(CrtPerCustInfoFER202509170047625Wrapper.class);
