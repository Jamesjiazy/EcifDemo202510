 ...
 * 
 */
public interface QurySignRelationInfoApplicationService {
     ...
     * @return
     */
    QurySignRelationInfoExecuteResponse QurySignRelationInfo(QurySignRelationInfoExecuteRequest request);
}
