 ...
 * 
 */
public class QuryCustAcctInfoByCustNoExecuteResponse
    extends CoreAppResponseHeader
{
    ...
    public QuryCustAcctInfoByCustNoExecuteResponse() {
    }
    ...
    public String toString() {
        return "QuryCustAcctInfoByCustNoExecuteResponse{" +
