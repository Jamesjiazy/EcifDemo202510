 ...
 * 
 */
public class CreatePerCustInfoCreatePerCustInfoRequest
    extends CoreAppRequestHeader
{
    ...
    public CreatePerCustInfoCreatePerCustInfoRequest() {
    }
    ...
    public String toString() {
        return "CreatePerCustInfoCreatePerCustInfoRequest{" +
				"crtfNo='" + crtfNo + '\'' +
				", crtfTypCd='" + crtfTypCd + '\'' +
				", custNm='" + custNm + '\'' +
				'}';
