package com.mcore.hsbc.ecif.domain.service.qurycustacctinfobycustacct;
 ...
 * 
 */
public interface QuryCustAcctInfoByCustAcctDomainService {
     ...
     * @return
     */
    QuryCustAcctInfoByCustAcctOutputDTO execute(QuryCustAcctInfoByCustAcctInputDTO input);
}
